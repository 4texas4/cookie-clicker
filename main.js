...
Game.Launch=function()
{
	...
	(App?'<div class="listing">'+loc("Music by %1.",'<a href="#" target="_blank">C418</a>')+'</div>':'')+
	//'<div class="listing">We have an <a href="#" target="_blank">official Discord</a>, as well as a <a href="#" target="_blank">forum</a>; '+
	'<div class="listing">'+(EN?
		'We have an <a href="#" target="_blank">official Discord</a>; if you\'re looking for help, you may also want to visit the <a href="#" target="_blank">subreddit</a> or the <a href="#" target="_blank">wiki</a>.<br>News and teasers are usually posted on Orteil\'s <a href="#" target="_blank">tumblr</a> and <a href="#" target="_blank">twitter</a>.'
		:
		loc("Useful links: %1, %2, %3, %4.",[
		'<a href="#" target="_blank" class="highlightHover smallBlackButton">Discord</a>',
		'<a href="#" target="_blank" class="highlightHover smallBlackButton">wiki</a>',
		'<a href="#" target="_blank" class="highlightHover smallBlackButton">tumblr</a>',
		'<a href="#" target="_blank" class="highlightHover smallBlackButton">twitter</a>',
		]))
	+'</div>'+
	(!App?'<div class="listing block" style="margin:8px 32px;font-size:11px;line-height:110%;color:rgba(200,200,255,1);background:rgba(128,128,255,0.15);" id="supportSection">'+loc(
		...
		[(!App?'<br><br>&bull; '+(EN?'get ':'')+'<a href="#" target="_blank" class="highlightHover smallWhiteButton">Cookie Clicker on Steam</a>':'')+''+(EN?' (it\'s about 5 bucks)':'')+'<br><br>&bull; '+(EN?'support us on ':'')+'<a href="#" target="_blank" class="highlightHover smallOrangeButton">Patreon</a>'+(EN?' (there\'s perks!)':'')+'<br><br>&bull; '+(EN?'check out our ':'')+'<a href="#" target="_blank" class="highlightHover smallWhiteButton">Shop</a>'+(EN?' with rad cookie shirts, hoodies and stickers':'')+((!App && EN)?'<br><br>&bull; disable your adblocker (if you want!)':'')]
	)+
	'</div></div>':'')+
	...
	'<div class="listing">&bull; Cookie Clicker has been <a href="#" target="_blank">released on Steam</a> with music by C418!</div>'+
	...
	'<div class="listing">&bull; added over 20 new cookies, all previously suggested by our supporters on <a href="#" target="_blank">Patreon</a></div>'+
	...
	'<div class="listing">&bull; added a new building</div>'+
	'<div class="listing">&bull; launched our <a href="#" class="orangeLink" target="_blank">Patreon</a> <span style="font-size:80%;">(the link is orange so you\'ll notice it!)</span></div>'+
	...
	Game.Load=function()
	{
		...
		Game.Loader.domain='https://unblocked-cookie-clicker.pages.dev/unblocked/img/';
...
window.onload=function()
{
	if (!Game.ready)
	{
		var loadLangAndLaunch=function(lang)
		{
			...
			LoadLang('https://unblocked-cookie-clicker.pages.dev/unblocked/loc/EN.js?v='+Game.version,function(lang){return function(){
				locStringsFallback=locStrings;
				LoadLang('https://unblocked-cookie-clicker.pages.dev/unblocked/loc/'+lang+'.js?v='+Game.version,function(){
					var launch=function(){
						Game.Launch();
